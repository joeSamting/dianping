...
//                voucherId.toString(), userId.toString(), String.valueOf(orderId)
        ...
        // 放入消息队列
        rabbitTemplate.convertAndSend(QUEUE_NAME, voucherOrder);
        // 3.获取代理对象
...
//        boolean success = seckillVoucherService.update(Wrappers.<SeckillVoucher>lambdaUpdate().setSql("stock = stock - 1")
